...
describe Pingfm::Keyloader do
  ...
  it "should use keys from yaml file if found" do
    ...
    loader.keyfile.should == @tmp_path
    loader.api_key.should == @keydata['api_key']
    loader.app_key.should == @keydata['app_key']
  end
  ...
  it "should save keys to keyfile" do
    ...
    YAML::load_file(loader.keyfile)['app_key'].should == 'baz'
  end
